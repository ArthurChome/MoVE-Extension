...
class MoveApp extends Application {
  ...
  //Procedure to initialize the MoVe application.
  override def start(stage: Stage): Unit = {
    ...
    stage.show()
    //the class MoveCtrl will make sure there's interaction with the FXML interface.
...
//Make an instance of the freshly defined class.
object MoveApp {
  import javafx.application.Platform
  val name: String = build.ProjectInfo.name
  val copyright: String = build.ProjectInfo.copyright
  val version: String = build.ProjectInfo.version
  val licenseName: String = build.ProjectInfo.licenseName
  ...
  //Here, all the source code gets executed.
